...
![](https://skillicons.dev/icons?perline=9&i=ts,docker,git,yarn,npm,nodejs,html,css,docker,jest,sqlite,java,php,figma,react,arduino,bun,cs,idea,mysql,postman,py,rider,vite,vscode)
